...
//            }
    ...
    public static class CalculateHIndexCommand implements Command {
        ...
        public void execute() {
            ...
            System.out.println(researcher.getPseudonym() + "'s H-Index: " + hIndex);
        }
    }
    ...
    public static class SubscribeToJournalCommand implements Command {
        ...
        @Override
        public void execute() {
            journal.getSubscribers().add(researcher);

            System.out.println(researcher.getPseudonym() + " is now subscribed to the journal: " + journal.getName());
        }
    }
    ...
    public static class TopCitedResearcherCommand implements Command {
        ...
        public TopCitedResearcherCommand(Researcher researcher, List<Researcher> allResearchers) {
            this.researcher = researcher;
        ...
        public void execute() {
            ...
            System.out.println("Top Cited Researcher: " + topCited.getPseudonym() + " with " + topCited.calculateCitations() + " citations.");
        }
